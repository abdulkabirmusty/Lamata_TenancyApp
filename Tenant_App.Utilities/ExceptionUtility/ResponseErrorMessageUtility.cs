...
namespace Tenant_App.Utilities.ExceptionUtility
{
    public class ResponseErrorMessageUtility
    {
        ...
        public const string StaffUploadSuccess = "Staffs uploaded successfully";
        ...
        public const string DataIsNull = "Your data can not be null.";
        ...
        public const string jobsaved = "Job Saved successfully";
        public const string IsJobAwardLetter = "1";
        ...
        public const string RecordDeleteBan = "Can't delete this record: You must have at least 3 records";
        public const string RecordCantDelete = "Can't delete this record: The Approval role is mapped to a staff";
        ...
        public const string DistributionNotactive = "Account has been made in-active";
        ...
        public const string NotApprove = "Your Application is yet to be approved, Kindly contact the system administrator";
        public const string FirstLoginChangePwd = "You are required to change your password";
        public const string NoActiveSubscription = "You do not have an active subscription";
        ...
        public const string Notchange = "Error occured while processing this request";
        public const string IllegalOperation= "You are not permitted to perform this operation";
        //public const string PasswordsDoNotMatch = "Passwords do not match. Please make sure the new password and confirm password fields are identical.";
        public const string PasswordsDoNotMatch = "Your current password is incorrect";
        ...
        public const string ValidateAccount= "Your account was activated successfully, you can now login with your credentials";
        ...
        public const string SessionExpired = "Your session has expired, please login again to continue";
        public const string Subscriptionexpired = "Your organization currently does not have an active subscription for WeApprove Portal, please subscribe using any of the plans below";
        public const string FreeTrialFail = "Your organization already subscribed for free trial, please subscribe using any of the plans below";
        public const string SubUserLimit = "Please choose a plan with a higher user limit";
        public const string FreeTrialSuccess = "Your organization has successfully subscribed for free trial";
        ...
        public const string PaymentFail = "Payment Failed";
        ...
        public const string PasswordInvalid = "Password should contain 8 or more characters with a mix of letters, upper case, numbers & symbols(e.g !#$%^&)";
        ...
        public const string NoRecord = "No Record at the Moment";
        public const string QueryRecord = "System Query";
        ...
        public const string ApprovalRoleUsed = "This role has already been assigned to a staff in your organization";
        public const string ApprovalLimit = "Approval Role limit reahced for your organization";
        ...
        public const string EmailError = "Your email is not a Valid Email valid use @";
        ...
        public const string CommentOperationFail = "Adding new Comment was not successful";
        public const string DeptHasStaffs = "Cannot delete department. The department contains staff member(s).";
        public const string UpdateStatusFail = "Your activation/deactivation operation was not successful";
        public const string UpdateStatusSuccess = "Your activation/deactivation operation was successful";
        public const string succesful = "Your request was successful";
        public const string UserLimit = "Maximum User Limit Reached: Your company has reached the maximum number of users allowed.";

        public const string succesregistration = "Your registration is successful, please verify your email";
        public const string succesfultrial = "Your free trial registration is successful, please verify your email";
        public const string Succesful = "Your  request was successful!";
        public const string TenantSuccesful = "Thank you for picking up the registration form. You will recieve mail notification once your request is Approved";
        public const string PaymentSuccesful = "Your payment has been successfully processed.";
        public const string PaymentFailure = "An Error occur, your payment was not successfully.";
        public const string TenantUnsuccesful = "Your create tenant operation failed";
        public const string ContestantSuccesful = "Congratulations! Your  request was successful. You will recieve mail notification once you are successfully selected.";
        public const string MemoSuccesful = "The Memo has been raised successfully and undergoing approval.";
        ...
        public const string MEMOACCEPTED = "Memo Approved Successfully";
